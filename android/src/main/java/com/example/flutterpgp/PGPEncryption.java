...
public class PGPEncryption {
    ...
    private static final String KEY_RING_ID = "zonesupport@zone.com.ng";
    ...
    public static String encrypt(String msgText, String publicKey) throws IOException, PGPException {
        ...
        PGPPublicKey encKey = getPublicKey(getPGPPublicKeyRing(publicKey.getBytes()));
    ...
    private static PGPPublicKeyRing getPGPPublicKeyRing(byte[] publicKey) throws IOException {
